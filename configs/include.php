...
define('C_FULL_PATH', 'C:/wamp/www/Parcial2AndresGonzalez/'); //full path

define('C_L_GLOBAL', 'http://localhost/Parcial2AndresGonzalez/'); //application global link
...
define('C_DB_DATABASE_NAME', 'parcial2'); //DB database name
